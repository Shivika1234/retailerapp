...
const handleeditShow = () => setEditShow(true);
    ...
    return (
      ...
      <Row>
        <Col> 
        <Button onClick={handleShow} style={{marginTop:"2vw",width:"7vw"}} variant="dark">Add role</Button>
      ...
      <Modal show={show} onHide={handleClose}>
        <Modal.Header closeButton>
          <Modal.Title>Roles form</Modal.Title>
        </Modal.Header>
        <Modal.Body>
        <Container>
      ...
      <Row>
        ...
        <Col xs={10}>
        <h2 style={{textAlign:"center",marginTop:"2vw"}}> Role information table</h2>

...
const handleShow = () => setShow(true);
    ...
    return (
      ...
      <Row>
        <Col> 
        <Button style={{marginTop:"2vw",width:"7vw"}} variant="dark">Add user</Button>
        ...
        <Col style={{marginLeft:"10vw"}} xs={10}>
        <h2 style={{textAlign:"center",marginTop:"0vw"}}> Subcategory information table</h2>
          ...
          <Table stickyHeader aria-label="sticky table">
            <TableHead>
              <TableRow>
                  ...
                  <TableCell align="center"> Sub category id</TableCell>
      ...
      <Container>
      <Row>
        <Col  onClick={()=>handleeditShow()} sm  style={{margin:"0px",padding:"0px"}}><button style={{width:"2.5vw"}}  className='editbutton btn btn-primary btn-sm'>

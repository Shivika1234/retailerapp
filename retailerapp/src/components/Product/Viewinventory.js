...
const handleeditShow = () => setEditShow(true);
    ...
    return (
      <>
        ...
        <div style={{marginTop:"1vw",width:"65vw",marginLeft:"10vw",backgroundColor:"#b3d9ff"}}>
        <h3 style={{textAlign:"center",fontWeight:"normal",marginTop:"1vw"}}> Inventry information </h3>
